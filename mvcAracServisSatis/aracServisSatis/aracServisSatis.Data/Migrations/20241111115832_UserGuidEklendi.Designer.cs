...
namespace aracServisSatis.Data.Migrations
{
    ...
    [Migration("20241111115832_UserGuidEklendi")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aracServisSatis.Entities.Arac", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aracServisSatis.Entities.Kullanici", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adi = "Admin",
                            AktifMi = true,
                            EklenmeTarihi = new DateTime(2024, 11, 11, 14, 58, 31, 153, DateTimeKind.Local).AddTicks(3849),
                            ...
                            Soyadi = "admin",
                            Telefon = "555",
                            UserGuid = new Guid("a5e3cc84-3d41-4d7a-81f2-5ebfd962f659")
                        });
                });

            modelBuilder.Entity("aracServisSatis.Entities.Marka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aracServisSatis.Entities.Musteri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aracServisSatis.Entities.Slider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtoServisSatis.Entities.Satis", b =>
                {
                    b.HasOne("aracServisSatis.Entities.Arac", "Arac")
                        .WithMany()
                        .HasForeignKey("AracId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("aracServisSatis.Entities.Musteri", "Musteri")
                        .WithMany()
            ...
            modelBuilder.Entity("aracServisSatis.Entities.Arac", b =>
                {
                    b.HasOne("aracServisSatis.Entities.Marka", "marka")
                        .WithMany()
